...
public class AssertionHwTest {
    ...
    @Test
    @DisplayName(value = "Проверка заголовка")
    ...
    public void textTest() {
        ...
        String bodyText = driver.findElement(By.cssSelector(".Card_body__35O4X")).getText();
        //Проверяем текст
    ...
    public void closeDriver() {
        driver.findElement(By.cssSelector(".img-fluid:nth-of-type(2)")).click();
